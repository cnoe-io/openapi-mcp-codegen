...
async def login_user(param_username: str = None, param_password: str = None) -> Any:
  '''
  ...
  Returns:
      Any: The JSON response from the API call, containing authentication details or error information.
