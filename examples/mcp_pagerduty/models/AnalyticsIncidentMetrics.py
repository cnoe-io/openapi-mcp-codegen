"""Model for AnalyticsIncidentMetrics"""
...
class Analyticsincidentmetrics(BaseModel):
    """Analyticsincidentmetrics model"""
...
class AnalyticsincidentmetricsResponse(APIResponse):
    """Response model for Analyticsincidentmetrics"""
    data: Optional[Analyticsincidentmetrics] = None

class AnalyticsincidentmetricsListResponse(APIResponse):
    """List response model for Analyticsincidentmetrics"""
    data: List[Analyticsincidentmetrics] = Field(default_factory=list)
