"""Model for ContentBasedAlertGroupingConfiguration"""
...
class Contentbasedalertgroupingconfiguration(BaseModel):
...
class ContentbasedalertgroupingconfigurationResponse(APIResponse):
    """Response model for Contentbasedalertgroupingconfiguration"""
    data: Optional[Contentbasedalertgroupingconfiguration] = None

class ContentbasedalertgroupingconfigurationListResponse(APIResponse):
    """List response model for Contentbasedalertgroupingconfiguration"""
    data: List[Contentbasedalertgroupingconfiguration] = Field(default_factory=list)
