"""Tools for /analytics/metrics/incidents/services/all operations"""
...
async def getAnalyticsMetricsIncidentsServiceAll() -> Dict[str, Any]:
    """
...
Scoped OAuth requires: `analytics.read`
    ...
    Returns:
        API response data
    """
    logger.debug(f"Making POST request to /analytics/metrics/incidents/services/all")
    params = {}
    data = None
