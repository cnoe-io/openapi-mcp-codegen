"""Tools for /analytics/metrics/incidents/escalation_policies/all operations"""
...
async def getAnalyticsMetricsIncidentsEscalationPolicyAll() -> Dict[str, Any]:
    """
...
Scoped OAuth requires: `analytics.read`
    ...
    Returns:
        API response data
    """
    logger.debug(f"Making POST request to /analytics/metrics/incidents/escalation_policies/all")
    params = {}
    data = None
