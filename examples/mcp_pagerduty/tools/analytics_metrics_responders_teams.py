"""Tools for /analytics/metrics/responders/teams operations"""
...
async def getAnalyticsMetricsRespondersTeam() -> Dict[str, Any]:
    """
...
Scoped OAuth requires: `analytics.read`
    ...
    Returns:
        API response data
    """
    logger.debug(f"Making POST request to /analytics/metrics/responders/teams")
    params = {}
    data = None
