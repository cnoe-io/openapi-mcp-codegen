"""Tools for /paused_incident_reports/counts operations"""
...
async def getPausedIncidentReportCounts() -> Dict[str, Any]:
    """
...
Scoped OAuth requires: `incidents.read`
    ...
    Returns:
        API response data
    """
    logger.debug(f"Making GET request to /paused_incident_reports/counts")
    params = {}
    data = None
