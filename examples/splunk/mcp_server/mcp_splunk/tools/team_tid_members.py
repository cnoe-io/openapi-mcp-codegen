...
async def add__team__member__list(path_tid: str, body_members: List[str] = None) -> Dict[str, Any]:
    '''
...
async def delete__team__members__list(path_tid: str, body_members: List[str] = None) -> Dict[str, Any]:
    '''
