...
async def get_application_svc_ls_links(path_name: str, param_namespace: str = None, param_project: str = None) -> Any:
  """
  ...
  success, response = await make_api_request(f"/api/v1/applications/{path_name}/links", method="GET", params=params, data=data)
