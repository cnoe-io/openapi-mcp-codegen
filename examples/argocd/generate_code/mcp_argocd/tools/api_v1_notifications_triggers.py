...
async def get_notification_svc_ls_triggers() -> Any:
  """
  ...
  success, response = await make_api_request("/api/v1/notifications/triggers", method="GET", params=params, data=data)
