...
async def get_application_svc_links(
  path_name: str,
  ...
  success, response = await make_api_request(f"/api/v1/applications/{path_name}/resource/links", method="GET", params=params, data=data)
