...
async def del_application_svc_term_operation(path_name: str, param_app_namespace: str = None, param_project: str = None) -> Any:
  """
  ...
  success, response = await make_api_request(f"/api/v1/applications/{path_name}/operation", method="DELETE", params=params, data=data)
