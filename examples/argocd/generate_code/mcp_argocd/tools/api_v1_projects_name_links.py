...
async def get_project_svc_ls_links(path_name: str) -> Any:
  """
  ...
  success, response = await make_api_request(f"/api/v1/projects/{path_name}/links", method="GET", params=params, data=data)
