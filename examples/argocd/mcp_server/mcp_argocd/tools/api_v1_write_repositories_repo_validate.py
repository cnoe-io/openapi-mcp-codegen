...
async def repository_service__validate_write_access(
    ...
    Args:
        path_repo (str): The path to the repository for which write access is being validated.
        ...
        param_githubAppPrivateKey (str, optional): GitHub App private key for authentication. Defaults to None.
        param_githubAppID (str, optional): GitHub App ID for authentication. Defaults to None.
        param_githubAppInstallationID (str, optional): GitHub App installation ID for authentication. Defaults to None.
        ...
        param_gcpServiceAccountKey (str, optional): GCP service account key for authentication. Defaults to None.
