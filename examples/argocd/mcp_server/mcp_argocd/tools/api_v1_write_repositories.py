...
async def repository_service__create_write_repository(
    ...
    Args:
        ...
        body_force_http_basic_auth (bool, optional): Forces HTTP basic authentication. Defaults to None.
        ...
        body_inherited_creds (bool, optional): Indicates if credentials are inherited. Defaults to None.
        body_insecure (bool, optional): Allows insecure connections. Defaults to None.
        body_insecure_ignore_host_key (bool, optional): Ignores host key verification. Defaults to None.
        body_name (str, optional): Name of the repository. Defaults to None.
        body_no_proxy (str, optional): No proxy settings. Defaults to None.
        ...
        body_repo (str, optional): Repository URL or path. Defaults to None.
        ...
        body_use_azure_workload_identity (bool, optional): Use Azure workload identity for authentication. Defaults to None.
