...
"""Tools for /api/v1/archived-workflows operations"""
...
async def get_arch_wf_svc_ls_arch_wfs(
  ...
  +optional
          ...
          param_name_prefix (str): OpenAPI parameter corresponding to 'param_name_prefix'
  ...
  """
  logger.debug("Making GET request to /api/v1/archived-workflows")
  ...
  if param_name_prefix is not None:
    params["name_prefix"] = str(param_name_prefix).lower() if isinstance(param_name_prefix, bool) else param_name_prefix
  ...
  success, response = await make_api_request("/api/v1/archived-workflows", method="GET", params=params, data=data)
