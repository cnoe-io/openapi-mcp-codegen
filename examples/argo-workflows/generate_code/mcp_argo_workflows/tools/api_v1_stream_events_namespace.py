...
"""Tools for /api/v1/stream/events/{namespace} operations"""
...
async def get_wf_svc_watch_events(
  path_namespace: str,
  ...
  """
  logger.debug("Making GET request to /api/v1/stream/events/{namespace}")
  ...
  success, response = await make_api_request(f"/api/v1/stream/events/{path_namespace}", method="GET", params=params, data=data)
