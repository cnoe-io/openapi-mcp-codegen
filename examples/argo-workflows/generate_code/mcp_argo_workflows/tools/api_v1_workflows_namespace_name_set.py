...
"""Tools for /api/v1/workflows/{namespace}/{name}/set operations"""
...
async def put_wf_svc_set_wf(
  ...
  body_output_parameters: str = None,
  body_phase: str = None,
) -> Any:
  """
  ...
  Args:
      ...
      body_output_parameters (str): OpenAPI parameter corresponding to 'body_output_parameters'
  ...
  if body_output_parameters is not None:
    flat_body["output_parameters"] = body_output_parameters
