...
"""Tools for /api/v1/stream/sensors/{namespace} operations"""
...
async def get_sns_svc_watch_snss(
  path_namespace: str,
  ...
  """
  logger.debug("Making GET request to /api/v1/stream/sensors/{namespace}")
  ...
  success, response = await make_api_request(f"/api/v1/stream/sensors/{path_namespace}", method="GET", params=params, data=data)
