...
async def get_evt_src_svc_ls_evt_srcs(
  path_namespace: str,
...
async def post_evt_src_svc_new_evt_src(
  path_namespace: str,
  body_event_source_metadata: Dict[str, Any] = None,
  body_event_source_spec: Dict[str, Any] = None,
  body_event_source_status_status_conditions: List[Dict[str, Any]] = None,
  ...
  Args:
      ...
      body_event_source_metadata (Dict[str, Any]): ObjectMeta is metadata that all persisted resources must have, which includes all objects users must create.

      body_event_source_spec (Dict[str, Any]): Request body as dictionary. Contains 35 nested properties. See OpenAPI schema for detailed structure.

      body_event_source_status_status_conditions (List[Dict[str, Any]]): OpenAPI parameter corresponding to 'body_event_source_status_status_conditions'
  ...
  flat_body = {}
  if body_event_source_metadata is not None:
    flat_body["event_source_metadata"] = body_event_source_metadata
  if body_event_source_spec is not None:
    flat_body["event_source_spec"] = body_event_source_spec
  if body_event_source_status_status_conditions is not None:
    flat_body["event_source_status_status_conditions"] = body_event_source_status_status_conditions
