...
async def get_wf_tpl_svc_ls_wf_tpls(
  path_namespace: str,
  param_name_pattern: str = None,
  ...
  """
      ...
      Args:
          ...
          param_name_pattern (str): OpenAPI parameter corresponding to 'param_name_pattern'
  ...
  if param_name_pattern is not None:
    params["name_pattern"] = str(param_name_pattern).lower() if isinstance(param_name_pattern, bool) else param_name_pattern
...
async def post_wf_tpl_svc_new_wf_tpl(
  path_namespace: str,
