...
async def get_wf_tpl_svc_get_wf_tpl(path_namespace: str, path_name: str, param_get_options_resource_version: str = None) -> Any:
  """
...
async def put_wf_tpl_svc_upd_wf_tpl(
  path_namespace: str,
  path_name: str,
  body_name: str = None,
...
async def del_wf_tpl_svc_del_wf_tpl(
  path_namespace: str,
  path_name: str,
