...
"""Tools for /api/v1/workflow-event-bindings/{namespace} operations"""
...
async def get_event_svc_ls_wf_event_bindings(
  path_namespace: str,
  ...
  """
  logger.debug("Making GET request to /api/v1/workflow-event-bindings/{namespace}")
  ...
  success, response = await make_api_request(f"/api/v1/workflow-event-bindings/{path_namespace}", method="GET", params=params, data=data)
