...
"""Tools for /api/v1/workflows/{namespace}/{name}/terminate operations"""
...
async def put_wf_svc_term_wf(path_namespace: str, path_name: str, body_name: str = None, body_namespace: str = None) -> Any:
  """
