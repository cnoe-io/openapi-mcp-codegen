...
async def event_service_list_workflow_event_bindings(
  path_namespace: str,
  ...
  """
  Retrieve details of a specific workflow-event-bindings

  OpenAPI Description:
      Lists workflow event bindings in a namespace. Use when: discovering event bindings or monitoring changes in a specific namespace.

  Args:

      path_namespace (str): "Kubernetes namespace to scope the workflow event binding operation"

      param_listOptions_labelSelector (str): "Filter results by label (e.g., app=nginx) to narrow search"
      ...
      param_listOptions_limit (int): Specifies max results to return; use to limit response size.
