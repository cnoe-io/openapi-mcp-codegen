...
async def sensor_service_watch_sensors(
  path_namespace: str,
  ...
  OpenAPI Description:
      Watches sensor updates in a namespace. Use when: monitoring real-time changes or tracking sensor status in a specific namespace.

  Args:

      path_namespace (str): "Kubernetes namespace to scope sensor retrieval"

      param_listOptions_labelSelector (str): Criteria to filter sensors by labels (e.g., type=temperature)
      ...
      param_listOptions_timeoutSeconds (int): Maximum time to wait for results in seconds (use to prevent long waits)

      param_listOptions_limit (int): "Maximum sensors to return (default: 50)"
