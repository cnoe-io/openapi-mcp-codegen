...
async def artifact_service_get_input_artifact_by_uid(path_uid: str, path_node_id: str, path_artifact_name: str) -> Any:
    """
    ...
    success, response = await make_api_request(
        f"/input-artifacts-by-uid/{path_uid}/{path_node_id}/{path_artifact_name}", method="GET", params=params, data=data
    )
