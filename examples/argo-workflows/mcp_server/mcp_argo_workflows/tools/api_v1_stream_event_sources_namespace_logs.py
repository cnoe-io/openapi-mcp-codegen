...
async def event_source_service_event_sources_logs(
    ...
    Args:
        ...
        param_eventSourceType (str): optional - only return entries for this event source type (e.g. `webhook`).

        param_eventName (str): optional - only return entries for this event name (e.g. `example`).
    ...
    success, response = await make_api_request(
        f"/api/v1/stream/event-sources/{path_namespace}/logs", method="GET", params=params, data=data
    )
