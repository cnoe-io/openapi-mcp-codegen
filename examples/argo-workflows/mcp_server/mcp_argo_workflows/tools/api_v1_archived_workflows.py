...
async def archived_workflow_service_list_archived_workflows(
    ...
    OpenAPI Description:
        List or query archived-workflows Use when: when you need to discover available resources or check what exists
    ...
    Args:
        ...
        param_namePrefix (str): Optional string parameter
