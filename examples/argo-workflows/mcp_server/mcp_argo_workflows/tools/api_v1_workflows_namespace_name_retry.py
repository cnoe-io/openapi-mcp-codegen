...
async def workflow_service_retry_workflow(
    path_namespace: str,
    path_name: str,
    body_name: str = None,
    ...
    OpenAPI Description:
        Update or replace a retry Use when: when modifying existing resource configurations or properties. Required: namespace, name, body
